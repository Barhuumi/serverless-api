...
* **Stack Name**: The name of the stack to deploy to AWS. This should be unique to your account and region, and a good starting point would be something matching your project name.
